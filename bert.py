...
parser.add_argument('--new_file_path', type=str, default='./dataset/Eclipse_morethan10_processed_again.csv', help='Path to the dataset file')
parser.add_argument('--checkpoint_path', type=str, default='model_checkpoint__eclipseprocessed_again_largebertwithid_abstract_com_largewithtop2and10.pth', help='Path to the model checkpoint file')
